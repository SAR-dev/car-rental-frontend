                ...
                <div className="grid grid-cols-1 gap-5 my-10">
                    {products.map((data) => {
                        ...
                        return [...Array(count)].map((_, i) => (
                            <div className="border border-base-200 shadow rounded-lg p-5 flex gap-8" key={`${data.id}-${i}`}>
                                ...
                                <div className='flex flex-col justify-between'>
                                    ...
                                    <button className="btn btn-primary" onClick={() => handleRemoveProduct(data.id)}>Remove from Cart</button>
                                </div>
                            </div>
                        ));
                    })}
